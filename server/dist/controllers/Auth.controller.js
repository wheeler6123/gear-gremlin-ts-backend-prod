...
import { secret, jwtExpiration } from '../config/Auth.js';
import { getGoogleOAuthTokens, getGoogleUser, findAndUpdateUser } from '../services/user.service.js';
//create controller 
const UserController = {
    ...
    //google Oauth login
    googleOauthLogin: async (req, res) => {
